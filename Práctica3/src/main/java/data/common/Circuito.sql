...
VALUES 
  ...
  ('purus.in.molestie@yahoo.org','QSQ78BKO2WZ','Driscoll Duran','1976-10-13 21:59:02','2022-01-31 07:43:17','Cliente'),
  ('scelerisque.neque@outlook.net','LHO98QWD8UK','Susan Buckner','2000-01-19 14:23:08','2022-11-06 16:39:48','Cliente'),
  ('donec.tempus.lorem@aol.com','CGC16CBY3WH','Caleb Wilkerson','2001-02-11 11:36:07','2022-07-06 21:04:21','Cliente'),
  ...
  ('dolor.vitae@protonmail.org','KPP24BXX5EH','Myles Bolton','1995-08-04 01:45:15','2022-08-22 21:37:48','Cliente'),
  ...
  ('nulla.cras.eu@outlook.com','SBD39UEU3PX','Gavin Freeman','1992-02-25 12:22:33','2022-04-08 01:30:02','Cliente'),
  ('ipsum@yahoo.com','DIU59RCR5JM','Deanna Colon','2001-05-26 10:18:48','2022-11-01 21:13:09','Cliente'),
  ('sed.turpis@google.edu','PQC77OWF8PR','Carly Avery','1986-09-18 02:41:57','2022-04-03 20:57:48','Cliente'),
  ('ultricies@google.org','DTV61EWH5EB','Amery Medina','1972-01-21 06:56:18','2022-09-13 12:06:31','Cliente'),
  ('vivamus.molestie.dapibus@yahoo.org','SJJ70BIF5YY','Karly Wells','1971-02-24 06:31:35','2022-12-07 18:56:08','Cliente'),
  ('gravida.praesent@google.couk','TUI37YHH1ID','Anthony Rocha','1984-02-16 10:13:44','2021-12-19 13:09:43','Cliente'),
  ('augue.scelerisque@protonmail.edu','XHI78PVX4XC','Bree Grimes','1975-04-24 16:03:28','2022-08-12 13:58:03','Cliente'),
...
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '0', 'Reservado', 'Brazil' );
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '1', 'Reservado', 'Tokio' );
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '1', 'Mantenimiento', 'Brazil' );
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '0', 'Reservado', 'Lisboa' );
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '1', 'Mantenimiento', 'Lisboa' );
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '1', 'Reservado', 'Tokio' );
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '0', 'Reservado', 'Lisboa' );
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '0', 'Reservado', 'Brazil' );
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '1', 'Reservado', 'Brazil' );
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '0', 'Reservado', 'Lisboa' );
INSERT INTO `Karts` ( `Child` , `State` , `TrackName` ) VALUES ( '0', 'Mantenimiento', 'Lisboa' );
INSERT INTO `Karts` ( `Child` , `State` ) VALUES ( '1', 'Disponible' );
INSERT INTO `Karts` ( `Child` , `State` ) VALUES ( '1', 'Disponible' );
INSERT INTO `Karts` ( `Child` , `State` ) VALUES ( '0', 'Disponible' );
INSERT INTO `Karts` ( `Child` , `State` ) VALUES ( '1', 'Disponible' );
INSERT INTO `Karts` ( `Child` , `State` ) VALUES ( '0', 'Disponible' );
